...
namespace tigertronics {
    ...
    namespace ports {
        ...
        static constexpr int intakeSolenoidPortRev = 3;

        //CLIMBER PORTS
        static constexpr int climberPTOPortFow = 0;
        static constexpr int climberPTOPortRev = 0;
        static constexpr int climberBrakePortFow = 0;
        static constexpr int climberBrakePortRev = 0;
        static constexpr int climberElevatorSolenoidPortFow = 5;
